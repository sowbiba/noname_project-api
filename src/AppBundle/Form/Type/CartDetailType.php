...
/**
 * FormType used to manage the creation and the update of cartDetails.
 */
class CartDetailType extends AbstractType
{
    ...
    {
        $builder
            ->add('cart',           'AppBundle\Form\SelectorType\CartSelectorType')
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            ...
            'data_class' => 'AppBundle\Entity\CartDetail',
        ]);
    }
}
